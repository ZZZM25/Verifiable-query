        ...
        for line_number, line in enumerate(file1, start=1):
            ...
            if line_number <= l1:
                ...
                with connection.cursor() as cursor:
                    ...
                    #####################  1
                    # query = "SELECT block_number,transaction_index FROM node_tx_node_eth WHERE start = %s AND block_number < %s;"
                    ...
                    #####################  1
                    # query = "SELECT block_number,transaction_index FROM node_tx_node_eth WHERE start = %s AND block_number < %s AND gas > %s;"
