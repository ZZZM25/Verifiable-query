        ...
        for line_number, line in enumerate(file1, start=1):
            ...
            if line_number <= l1:
                ...
                with connection.cursor() as cursor:
                    ...
                    #####################  1
                    # query = "SELECT DISTINCT end FROM node_tx_node WHERE start = %s AND block_number < %s;"
                    ...
                    #####################  1
                    # query = "SELECT DISTINCT end FROM node_tx_node WHERE start = %s AND block_number < %s AND gas <= %s;"
